                                ...
                                <div className="p-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white flex justify-between items-center">
                                    ...
                                    <div className="flex gap-2 bg-blue-700 p-1 rounded-lg">
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-md font-medium text-sm transition-all ${viewMode === 'tabla' ? 'bg-white text-blue-600 shadow-md' : 'text-blue-100 hover:text-white'}`}
                                        >
                                            📊 Tabla
                                        </button>
                                        <button
                                            onClick={() => setViewMode('kanban')}
                                            className={`px-4 py-2 rounded-md font-medium text-sm transition-all ${viewMode === 'kanban' ? 'bg-white text-blue-600 shadow-md' : 'text-blue-100 hover:text-white'}`}
                                        >
                                            📋 Kanban
                                        </button>
                                    </div>
